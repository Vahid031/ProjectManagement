...
(function ($) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        removeLabel: 'حذف',
        removeTitle: 'حذف فایل های انتخابی',
        cancelLabel: 'انصراف',
        cancelTitle: 'انصراف از ذخیره تصویر',
        uploadLabel: 'ذخیره',
        uploadTitle: 'ذخیره فایل های انتخابی',
        msgSizeTooLarge: 'فایل "{name}" (<b>{size} KB</b>) بیشتر از اندازه مورد انتظار است <b>{maxSize} KB</b>. لطفا دوباره امتحان کنید!',
        msgFilesTooLess: 'حداقل اندازه موردنظر <b>{n}</b> {files} میباشد. لطفا دوباره امتحان کنید!',
        msgFilesTooMany: 'تعداد فایل های انتخابی <b>({n})</b> بیشتر از حد موردنظر است <b>{m}</b>. لطفا دوباره امتحان کنید!',
        msgFileNotFound: 'فایل "{name}" یافت نشد!',
        msgFileSecured: 'فایل مورد نظر خوانده نشد "{name}".',
        msgFileNotReadable: 'فایل "{name}" قابل خواندن نیست.',
        msgFilePreviewAborted: 'نمایش فایل "{name}" با خطا مواجه شد.',
        msgFilePreviewError: 'خطا هنگام خواندن فایل "{name}".',
        msgInvalidFileType: 'نوع فایل  "{name}" نامعتبر است. فقط "{types}" قابل پشتیلانی میباشند.',
        msgInvalidFileExtension: 'پسوند فایل "{name} نامعتبر است". فقط "{extensions}" قابل پشتیبانی میباشند.',
        msgValidationError: 'خطا در ذخیره فایل',
        msgLoading: 'ذخیره فایل {index} از {files} &hellip;',
        msgProgress: 'ذخیره فایل {index} از {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} انتخاب شده',
        msgFoldersNotAllowed: 'فقط فایل! {n} پوشه ها نادیده گرفته میشوند.',
        dropZoneTitle: 'تصویر مورد نظر را اینجا بکشید و رها کنید &hellip;'
    };
