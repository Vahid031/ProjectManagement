(function() {
    ...
    k.AmSlicedChart = k.Class({
        ...
        clickSlice: function(a, b, c) {
            this.checkTouchDuration() && (isNaN(a) || (a = this.chartData[a]), a.pulled ? this.pullSlice(a, 0) : this.pullSlice(a, 1), k.getURL(a.url, this.urlTarget), c || this.fire({
                type: "clickSlice",
                dataItem: a,
                chart: this,
                event: b
    ...
    k.AmPieChart = k.Class({
        ...
        drawChart: function() {
            ...
            if (k.ifArray(a)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    l = f(this.radius, d, g);
                    l || (d = 0 <= x ? d - h - e - 2 * p : d - h - e, g = g - z - n, l = Math.min(d, g), g < d && (l /= 1 - this.angle / 90, l > d && (l = d)), g = k.toCoordinate(this.pullOutRadius, l), l = (0 <= x ? l - 1.8 * (x + g) : l - 1.8 * g) / 2);
                    ...
                    360 < n && (n -= 360);
                    d = l - l * this.angle / 90;
                    for (h = p = 0; h < a.length; h++) e = a[h], !0 !== e.hidden && (p += k.roundTo(e.percents, this.pf.precision));
                    ...
                    for (var D, h = 0; h < a.length; h++)
                        if (e = a[h], !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents)) {
                            ...
                            if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
                                ...
                                if (0 <= t) {
                                    var y;
                                    90 >= m && 0 <= m ? (y = 0, w = "start", u = 8) : 90 <= m && 180 > m ? (y = 1, w = "start", u = 8) :
                                        180 <= m && 270 > m ? (y = 2, w = "end", u = -8) : 270 <= m && 354 >= m ? (y = 3, w = "end", u = -8) : 354 <= m && (h > D ? (y = 0, w = "start", u = 8) : (y = 3, w = "end", u = -8));
                                    e.labelQuarter = y
                                } else w = "middle";
                                ...
                                t = e.labelColor;
                                t || (t = this.color);
                                "" !== m && (m = k.wrappedText(c, m, t, this.fontFamily, this.fontSize, w, !1, this.maxLabelWidth), k.setCN(this, m, "pie-label"), k.setCN(this, m, e.className, !0), m.translate(r + 1.5 * u, E), m.node.style.pointerEvents = "none", e.ty = E, e.textX = r + 1.5 * u, v.push(m), this.axesSet.push(v), e.labelSet = v, e.label = m);
                                e.tx = r;
                                e.tx2 = r + u;
                                e.tx0 = A + p * l;
                                e.ty0 = B + C * l
                            ...
                            if (0 === e.alpha || 0 < b && !this.chartCreated) q.hide(), v && v.hide();
        ...
        checkOverlapping: function(a, b, c, d, g) {
            ...
            if (n) {
                ...
                !0 === f && 100 > g && isNaN(b.labelRadius) && (f = b.ty + 3 * b.iy, b.ty = f, n.translate(b.textX, f), this.checkOverlapping(a, b, c, d, g + 1))
            }
        },
